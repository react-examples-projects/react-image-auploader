class ImageController {
  constructor() {
    ...
    this.CommentService = require("../services/commentService");
  ...
  async deleteImage(id, idUser) {
    const p1 = this.CommentService.deleteAllCommentsByPost(id);
    const p2 = this.UserService.deleteFavorite({ idUser, idImage: id });
